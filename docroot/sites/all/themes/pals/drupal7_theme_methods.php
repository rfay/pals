...
function pals_process_html(&$variables) {
...
function pals_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function pals_button($variables) {
 ...
 */
function pals_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function pals_menu_local_task($variables) {
 ...
 */
function pals_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function pals_node_preview($variables) {
  $node = $variables['node'];
