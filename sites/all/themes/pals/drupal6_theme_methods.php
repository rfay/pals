...
function pals_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function pals_feed_icon($url, $title) {
 ...
 */
function pals_preprocess_comment_wrapper(&$vars) {
 ...
 */
function pals_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function pals_service_links_node_format($links) {
...
*/
function pals_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function pals_node_preview($node) {
